          ...
          <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card className="bg-slate-800/50 border-slate-700 backdrop-blur-lg">
              ...
              <CardContent className="space-y-3">
                <WithTooltip tooltip="Navigate to Members page to add, view, and manage all gym members">
                  <button
                    onClick={() => navigate('/members')}
                    className="w-full text-left p-4 rounded-lg bg-slate-700/50 hover:bg-slate-700 transition-colors text-white border border-slate-600"
                ...
                <WithTooltip tooltip="Access member check-in system and view access logs">
                  <button
                ...
                <WithTooltip tooltip="Manage billing, create invoices, and view payment history">
                  <button
