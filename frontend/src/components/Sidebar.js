...
import { LayoutDashboard, Users, ScanLine, FileText, UserX, DollarSign, TrendingUp, Package, Settings, LogOut, Dumbbell, Zap, BarChart3, Calendar, Upload, Shield, UserCog, ShoppingCart, Tag, CreditCard, Activity, CheckSquare, Receipt, FileBarChart, LineChart, Award, Target } from 'lucide-react';
...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    { path: '/engagement', icon: Target, label: 'Engagement', testId: 'nav-engagement', module: 'reports' },
    { path: '/rewards', icon: Award, label: 'Points & Rewards', testId: 'nav-rewards', module: 'reports' },
